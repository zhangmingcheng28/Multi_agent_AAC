...
import pickle
import wandb
from parameters_randomOD_Wgru_radar import initialize_parameters
from maddpg_agent_randomOD_Wgru_radar import MADDPG
from utils_randomOD_Wgru_radar import *
...
from Utilities_own_randomOD_Wgru_radar import *
...
def main(args):
    ...
    if args.mode == "eval":
        ...
        pre_fix = r'D:\MADDPG_2nd_jp\230124_11_56_07\interval_record_eps'
    ...
    while episode < args.max_episodes:  # start of an episode
        ...
        while True:  # start of an episode (this episode ends when (agent_added < max_agent_to_add))
            if args.mode == "train":
                ...
                gru_history.append(np.array(norm_cur_state[0]))  # this is a dummy not useful for now
