...
from agent_randomOD_Wgru_radar import Agent
import pandas as pd
import math
import numpy as np
import os
...
class env_simulator:
    ...
    def ss_reward(self, current_ts, step_reward_record, eps_status_holder, step_collision_record, xy):
        ...
        for drone_idx, drone_obj in self.all_agents.items():
            ...
            for wpidx, wp in enumerate(self.all_agents[drone_idx].goal):
                ...
                if cur_dist_to_wp < smallest_dist:
                    ...
                    if smallest_dist < wp_reach_threshold_dist:
                        ...
                        # after remove the wp, we find the next wp, as long as it is not the last wp
            ...
            near_goal_reward = near_goal_coefficient * 0
