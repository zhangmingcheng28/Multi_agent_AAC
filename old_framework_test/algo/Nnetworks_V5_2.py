...
class ActorNetwork(nn.Module):
    def __init__(self, actor_obs, n_actions):  # actor_obs consists of three parts 0 = own, 1 = own grid, 2 = surrounding drones
        ...
        self.own_fc = nn.Sequential(nn.Linear(actor_obs, 512), nn.ReLU())
