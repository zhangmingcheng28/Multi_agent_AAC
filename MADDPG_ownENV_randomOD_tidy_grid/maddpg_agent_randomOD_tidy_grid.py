...
from Nnetworks_randomOD_tidy_grid import CriticNetwork, ActorNetwork, Stocha_actor, GRU_actor, CriticNetwork_woGru, CriticNetwork_wGru
import torch
from copy import deepcopy
from torch.optim import Adam
from memory_randomOD_tidy_grid import ReplayMemory, Experience
...
import numpy as np
import torch as T
from utils_randomOD_tidy_grid import device
import csv
scale_reward = 0.01
...
class MADDPG:
    ...
    def update_myown(self, i_episode, total_step_count, UPDATE_EVERY, wandb=None):
        ...
        for agent in range(self.n_agents):
            ...
            whole_state = [stacked_elem_0_combine, stacked_elem_1_combine]  # own_state only
            next_whole_state = [next_stacked_elem_0_combine, next_stacked_elem_1_combine]
            ...
            with T.no_grad():
                ...
                next_target_critic_value = self.critics_target[agent](next_whole_state, non_final_next_actions).squeeze()
