...
from agent_MADDPGv2 import Agent
import pandas as pd
import math
import numpy as np
import os
...
class env_simulator:
    ...
    def reset_world(self, show):  # set initialize position and observation for all agents
        ...
        overall_state, norm_overall_state = self.cur_state_norm_state_v2(agentRefer_dict)
    ...
    def step(self, actions, current_ts):
        ...
        next_state, next_state_norm = self.cur_state_norm_state_v2(agentRefer_dict)
