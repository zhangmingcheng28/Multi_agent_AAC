...
"""
import numpy as np
from grid_env_generation_newframe_MADDPGv2 import env_generation
from env_simulator_MADDPGv2 import env_simulator
...
def initialize_parameters():
    ...
    # agentConfig = (r'F:\githubClone\Multi_agent_AAC\MA_ver1\fixedDrone_5_adj_forV2.xlsx')
    # agentConfig = (r'D:\Multi_agent_AAC\MA_ver1\fixedDrone.xlsx')
    # agentConfig = (r'D:\Multi_agent_AAC\MA_ver1\fixedDrone_2_drone.xlsx')
    # agentConfig = (r'D:\github_clone\Multi_agent_AAC\MA_ver1\fixedDrone_2_drone.xlsx')
    # agentConfig = (r'D:\github_clone\Multi_agent_AAC\MA_ver1\fixedDrone_5_adj_forV2.xlsx')
    agentConfig = (r'D:\Multi_agent_AAC\MA_ver1\fixedDrone_5_adj_forV2.xlsx')
