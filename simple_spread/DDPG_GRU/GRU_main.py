...
from GRU_MADDPG import GRU_MADDPG
import os
...
if __name__ == '__main__':
    ...
    maddpg = GRU_MADDPG(obs_dim_list, act_dim_list, args.buffer_capacity, args.actor_lr, args.critic_lr, hidden_dim_list, res_dir)
    ...
    for episode in range(args.episode_num):
        ...
        for step in range(args.episode_length):  # interact with the env for an episode
            actions, next_hiddens = maddpg.select_action(obs, hiddens)
            ...
            maddpg.add(obs, actions, hiddens, rewards, next_obs, next_hiddens, dones)
