...
class BasePolicy(nn.Module):
    ...
    def __init__(self, input_dim, out_dim, hidden_dim=64, nonlin=F.leaky_relu,
        ...
        self.fc_out = nn.Sequential(nn.Linear(128, out_dim))
...
class DiscretePolicy(BasePolicy):
    ...
    def forward(self, obs, eps=0, sample=True, return_all_probs=False, return_log_pi=False, regularize=False, return_entropy=False):
        ...
        if sample:
            ...
            act = onehot_from_logits(probs, eps)
        rets = [act]
