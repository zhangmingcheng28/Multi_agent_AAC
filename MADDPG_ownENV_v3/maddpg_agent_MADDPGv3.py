...
from memory_MADDPGv3 import ReplayMemory, Experience
from random_process_MADDPGv3 import OrnsteinUhlenbeckProcess
from torch.autograd import Variable
import os
import torch.nn as nn
import numpy as np
import torch as T
from utils_MADDPGv3 import device
import csv
scale_reward = 0.01
...
class MADDPG:
    ...
    def update_myown(self, i_episode, total_step_count, UPDATE_EVERY):
        ...
        for agent in range(self.n_agents):
            ...
            non_final_next_actions = [self.actors_target[i]([non_final_next_states[0][i], non_final_next_states[1][i], non_final_next_states[2][i]]) for i in range(self.n_agents)]  # non_final_next_states[:, i,:]
