from Nnetworks_MADDPGv1 import CriticNetwork, ActorNetwork
import torch
from copy import deepcopy
from torch.optim import Adam
from memory_MADDPGv1 import ReplayMemory, Experience
from random_process_MADDPGv1 import OrnsteinUhlenbeckProcess
from torch.autograd import Variable
import os
import torch.nn as nn
import numpy as np
import torch as T
from utils_MADDPGv1 import device
import csv
scale_reward = 0.01
    ...
    def update_myown(self, i_episode, total_step_count, UPDATE_EVERY):
        ...
        for agent in range(self.n_agents):
            ...
            with T.no_grad():
                ...
                target_Q = (target_Q.unsqueeze(1) * self.GAMMA) + (
                        reward_batch[:, agent].unsqueeze(1))  # + reward_sum.unsqueeze(1) * 0.1
            loss_Q = nn.MSELoss()(current_Q, target_Q.detach())
            self.critic_optimizer[agent].zero_grad()
